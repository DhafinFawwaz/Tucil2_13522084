...
<div class="flex gap-2 mx-4">
  ...
  <input type="number" class="bg-slate-800 duration-100 px-2 py-1 text-slate-50 rounded-lg shadow-sm outline-none ring ring-transparent focus:ring-indigo-500 grow w-16">
