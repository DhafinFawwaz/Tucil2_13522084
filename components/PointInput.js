...
<div class="flex gap-2 mx-4">
  ...
  <input step=50 type="number" class="bg-slate-800 duration-100 px-2 py-1 text-slate-50 rounded-lg shadow-sm outline-none ring ring-transparent focus:ring-indigo-500 ring-inset grow w-16" value=${defaultX}>

  <input step=50 type="number" class="bg-slate-800 duration-100 px-2 py-1 text-slate-50 rounded-lg shadow-sm outline-none ring ring-transparent focus:ring-indigo-500 ring-inset grow w-16"value=${defaultY}>
